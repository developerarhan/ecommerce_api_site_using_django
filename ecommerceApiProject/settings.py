...
# now we can acces environment variable(.env)
load_dotenv() 
...
SECRET_KEY = 'django-insecure-dx282(n9h1u_m2sb^7+dx(m4^vd26!8nw=t+n$g=jj4&f17u&@'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'railway',
        'USER': 'postgres',
        'PASSWORD': 'YkdRzuxEyUXJFNfmqywQxutFNhtauqQR',
